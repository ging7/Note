...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RelativeLayout typeColor = itemView.findViewById(R.id.type_color);
        ImageView selectedItem = itemView.findViewById(R.id.selected_item);
        TextView titleView = itemView.findViewById(R.id.title_text);
